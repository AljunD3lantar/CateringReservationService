...
public class caterpackcont extends javax.swing.JFrame {

   
    public caterpackcont() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(caterpackcont.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new caterpackcont().setVisible(true);
            }
        });
    }
