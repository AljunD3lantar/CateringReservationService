...
public class CateringPackages extends javax.swing.JFrame {
    ...
    private void WeddingMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_WeddingMouseClicked
        caterpackcontent cpc = new caterpackcontent();
        cpc.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_WeddingMouseClicked
