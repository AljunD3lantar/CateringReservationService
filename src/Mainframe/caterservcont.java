...
public class caterservcont extends javax.swing.JFrame {

   
    public caterservcont() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(caterservcont.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new caterservcont().setVisible(true);
            }
        });
    }
