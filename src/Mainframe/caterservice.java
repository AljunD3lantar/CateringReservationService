...
public class caterservice extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 900, 80));
        ...
        jLabel1.setText(" CATERING SERVICES");

        jPanel14.setBackground(new java.awt.Color(0, 0, 0));

        jLabel26.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel26.setForeground(new java.awt.Color(255, 255, 255));
        jLabel26.setText("Call Us PLDT 1234-5678     |    Mobile Number: 0945-547-4321    |     Gmail: aldelantar91@gmail.com");
        ...
        jLabel14.setText("DEBUT");

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setText("KIDS PARTY");

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Debut (1).png"))); // NOI18N

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/OIP.png"))); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/kids_party (1).png"))); // NOI18N
        ...
        jPanel4.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 80, 660, 530));
    ...
    private void RentalsMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RentalsMouseEntered
        Rentals.setBackground(hovering);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(caterservice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new caterservice().setVisible(true);
            }
        });
    }
